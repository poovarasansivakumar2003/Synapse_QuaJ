    ...
    <BrowserRouter>
      ...
      >
        <Routes>
          ...
          <Route exact path="/student/profile" name="Student Dashboard" element={<StudentDashboard />} />
          <Route exact path="/alumni/profile" name="Alumni Dashboard" element={<AlumniDashboard />} />
          <Route exact path="/admin/profile" name="Admin Dashboard" element={<AdminDashboard />} />
